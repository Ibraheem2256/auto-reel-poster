...
/**
 * Returns the AI-generated publish content (title, caption, hashtags,
 * description) for a video so it can be reviewed/edited before posting.
 * Slow on first call per video (vision analysis); cached afterwards.
 */
