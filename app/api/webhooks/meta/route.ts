...
export async function POST(req: NextRequest) {
  ...
  // Webhook verification handshake (Facebook requires a 200 + echo).
  ...
  try {
    ...
    // We only use webhooks for status information; store only what is needed.
    // No video data ever passes through webhooks.
